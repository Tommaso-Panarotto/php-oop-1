...
$deadpool = new Movie(
    'Deadpool',
    'Wade Wilson è un ex membro delle Forze Speciali diventato mercenario. Dopo un esperimento non autorizzato che gli conferisce il potere di guarigione veloce.',
    new Genres('Azione', 'Thriller'),
    '18+'
);
